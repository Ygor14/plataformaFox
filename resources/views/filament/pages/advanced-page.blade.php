<x-filament-panels::page>
    ...
    <!--<div class="w-full p-4 bg-gray-500 shadow-lg"-->
    <!--    style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">-->
    ...
    <!--            <button wire:click="loadProviderEvergame" style="border-radius: 10px"-->
    <!--                class="bg-primary-600 px-3 py-2 w-full text-center">-->
    ...
    <!--        </div>-->
    <!--        <button wire:click="loadGamesEvergame"-->
    <!--            style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9"-->
    <!--            class="bg-primary-500 px-3 py-2 w-full">-->
    ...
    <!--                            style="display: block; shape-rendering: auto; animation-play-state: running; animation-delay: 0s; max-width: 32px; margin-right: 8px;"-->
    ...
    <!--                                style="transform: scale(0.8); transform-origin: 50px 50px 0px; animation-play-state: running; animation-delay: 0s;">-->
    ...
    <!--    <div class="flex justify-between w-full gap-4">-->
    <!--        <div class="flex flex-col gap-4 w-full justify-between">-->
    <!--            <button wire:click="loadProviderDrakon" style="border-radius: 10px"-->
    <!--                class="bg-primary-600 px-3 py-2 w-full text-center">-->
    ...
    <!--        </div>-->
    <!--        <button wire:click="loadGamesDrakon"-->
    <!--            style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9"-->
    <!--            class="bg-primary-500 px-3 py-2 w-full">-->
    <!--            <div class="flex flex-col gap-4 w-full justify-between">-->
    ...
    <div class="w-full p-4 bg-gray-500 shadow-lg"
        style="background-color: #51515163; border-radius: 20px; border: 5px solid; animation: border-color-animation 4s infinite;">
        <h2 class="mb-5 text-3xl">Games Lot </h2>
        <p>Velocidade e Estabilidade inagualável!
        </p>
        <br>
        <div class="flex justify-between w-full gap-4">
            <div class="flex flex-col gap-4 w-full justify-between">
                <button wire:click="loadProviderPlayConnect" style="border-radius: 10px"
                    class="bg-primary-600 px-3 py-2 w-full text-center">
            ...
            <button wire:click="loadGamesPlayConnect"
                style="border-radius: 10px; overflow: hidden; position: relative; background-color: #7f3cb9"
                class="bg-primary-500 px-3 py-2 w-full">
                <div style="flex flex-col gap-4 w-full justify-between; color: #ffffff;">
