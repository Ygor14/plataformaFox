...
use App\Filament\Admin\Resources\SliderTextResource\Pages;
use App\Filament\Admin\Resources\SliderTextResource\RelationManagers;
...
class SliderTextResource extends Resource
{
    protected static ?string $model = SliderText::class;
   ...
   // protected static ?string $navigationIcon = 'heroicon-o-arrow-path-rounded-square';
    ...
    {
        return [
            'index' => Pages\ListSliderTexts::route('/'),
            'create' => Pages\CreateSliderText::route('/create'),
            'edit' => Pages\EditSliderText::route('/{record}/edit'),
        ];
    }
}
